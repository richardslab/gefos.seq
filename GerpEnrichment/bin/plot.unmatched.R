...
plot.it <- function(ph, main) {
  ...
  cpch = 21
  tpch = 19
  table.f = paste(ph, ".unmatched/table.txt", sep="")
...
phenos <- list(list("ls7final", "Lumbar Spine"),
          list("fn9final", "Femoral Neck"),
          list("fa4prefinal2", "Forearm"))

png(file="figure.unmatched.png", res=240, width=2400, height=1200)
